  ...
  return (
    <div className='flex flex-col flex-grow gap-2'>
      ...
      <form
        ...
        className='flex gap-2 mb-2 w-full items-center py-2 px-3 rounded-lg bg-gray-700'
      >
        <textarea
          name='message'
          required
          ...
          rows={1}
          className='block mx-2 p-2.5 w-full text-sm  rounded-lg border bg-gray-800 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500'
